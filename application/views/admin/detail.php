                 ...
                 <div class="col-sm-6">
                     <ol class="breadcrumb float-sm-right">
                         <li class="breadcrumb-item">
                             <a href="<?php echo base_url('admin/list_dokumen/' . $detail['kategori_id']); ?>" class="btn btn-light btn-sm">Kembali</a>
                         </li>
                     </ol>
                 </div>
             </div>
                 ...
                 <div class="col-md-4">
                     <div class="card">
                         ...
                         <div class="card-body p-0">
                             ...
                             <hr>
                             <div class="pb-3 pr-2"><a href="<?php echo base_url('admin/edit_data/' . $detail['id_arsip']); ?>" class="btn btn-info btn-sm float-right"><i class="fas fa-edit"></i> Edit Arsip</a></div>
                             <br>
                         </div>
                     </div>
                 </div>
                             ...
                             <ul class="mailbox-attachments d-flex align-items-stretch clearfix">
                                 <li>
                                     ...
                                     <div class="mailbox-attachment-info">
                                         <center><a href="<?php echo base_url('admin/detail/' . $detail['id_arsip']); ?>" class="mailbox-attachment-name"><i class="fas fa-paperclip"></i> <?php echo $detail['file_arsip']; ?></a>
                                         </center>
                                         <span class="mailbox-attachment-size clearfix mt-1">
                                             <a href="<?php echo base_url('admin/unduh_arsip/' . $detail['id_arsip']); ?>" class="btn btn-primary btn-sm btn-block"><i class="fas fa-cloud-download-alt"></i> Unduh</a>
                                         </span>
                                     </div>
                                 </li>
                             </ul>
