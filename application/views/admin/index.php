        ...
        <div class="container-fluid">
            <div class="alert alert-secondary" role="alert">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <button type="button" class="btn btn-outline-primary btn-sm float-right ml-1" data-toggle="modal" data-target="#ubah-pass">Ubah Password</button>
                        <button type="button" class="btn btn-outline-primary btn-sm float-right" data-toggle="modal" data-target="#profile">Ubah Profil</button>
                    </div>
                </div>
            </div>
            <div class="row">
