        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
               ...
               with font-awesome or any other icon font library -->
                ...
                <li class="nav-item has-treeview">
                    <a href="<?php echo base_url('user/input_data'); ?>" class="nav-link">
                ...
                <li class="nav-item has-treeview">
                    ...
                    <ul class="nav nav-treeview">
                        <?php foreach ($kategori_sidebar as $lu) : ?>
                            <li class="nav-item">
                                <a href="<?php echo base_url('user/list_dokumen/' . $lu['id_kategori']); ?>" class="nav-link">
                ...
                <li class="nav-item has-treeview">
                    ...
                    <ul class="nav nav-treeview">
                        <?php foreach ($kategori_sidebar as $lu) : ?>
                            <li class="nav-item">
                                <a href="<?php echo base_url('user/publik_dokumen/' . $lu['id_kategori']); ?>" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p><?php echo $lu['nama_kategori']; ?></p>
                                </a>
                            </li>
