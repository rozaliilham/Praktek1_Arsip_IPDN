        ...
        <div class="container-fluid">
            ...
            <div class="alert alert-secondary" role="alert">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <button type="button" class="btn btn-outline-secondary btn-sm float-right ml-1" data-toggle="modal" data-target="#ubah-pass">Ubah Password</button>
                        <button type="button" class="btn btn-outline-secondary btn-sm float-right" data-toggle="modal" data-target="#profile">Ubah Profil</button>
                    </div>
                </div>
            </div>
            <div class="row">
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($list_dokumen as $lu) : ?>
                                            <tr>
                                                ...
                                                <td><?php echo $lu['file_arsip']; ?></td>
                                                <?php if ($lu['status_arsip'] == '0') : ?>
                                                    <td class="font-weight-bolder text-danger">Publik</td>
                                                <?php else : ?>
                                                    <td class="font-weight-bolder text-success">Private</td>
                                                <?php endif; ?>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
