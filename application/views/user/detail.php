                 ...
                 <div class="col-sm-6">
                     <ol class="breadcrumb float-sm-right">
                         <li class="breadcrumb-item">
                             <a href="<?php echo base_url('user/list_dokumen/' . $detail['kategori_id']); ?>" class="btn btn-light btn-sm">Kembali</a>
                         </li>
                     </ol>
                 </div>
             </div>
                 ...
                 <div class="col-md-4">
                     <div class="card">
                         ...
                         <div class="card-body p-0">
                             ...
                             <hr>
                             <div class="pb-3 pr-2"><a href="<?php echo base_url('user/edit_data/' . $detail['id_arsip']); ?>" class="btn btn-info btn-sm float-right"><i class="fas fa-edit"></i> Edit Arsip</a></div>
                             <br>
                         </div>
                     </div>
                 </div>
