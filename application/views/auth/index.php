...
<head>
    ...
    <title>Login</title>
    <link rel="shortcut icon" href="<?php echo base_url('assets/'); ?>dist/img/adonia.png">
...
<style>
    .bg {
        background: url("<?php echo base_url('assets/dist/'); ?>img/arsip.jpg") no-repeat center center fixed;
            ...
            <div class="card-body login-card-body">
                ...
                <form action="<?php echo base_url('auth/index'); ?>" method="post">
                    ...
                    <div class="row">
                        ...
                        <!-- /.col -->
                        <div class="col-4">
                            <button type="submit" class="btn btn-info btn-block btn-sm"><i class="fas fa-sign-in-alt"></i> Sign In</button>
                        </div>
                        <!-- /.col -->
                    </div>
                </form>
